...
//   final String? tripId; // Make this optional with ?

//   const ShowRiderDetails({
//     super.key, 
//     required this.tripDetails, 
//     required this.initialTripDetails,
//     this.tripId // Make it optional
//   });
...
//   log('Socket initialization starting...');
//   socket = IO.io(Constants.apiBaseUrl, <String, dynamic>{
//     'transports': ['websocket'],
//     'autoConnect': true,
//   });

//   // Find the passenger ID with fallbacks
//   String? passengerId;
//   try {
//     // Log the structure to debug
//     log('TripDetails keys: ${widget.tripDetails.keys.join(', ')}');
    
//     // Try different paths to find passenger ID
//     if (widget.tripDetails.containsKey('passenger')) {
//       passengerId = widget.tripDetails['passenger']['_id'];
//     } else if (widget.tripDetails.containsKey('tripDetails')) {
//       passengerId = widget.tripDetails['tripDetails']['passenger']['_id'];
//     }
    
//     if (passengerId != null) {
//       log('Found passenger ID: $passengerId');
//     } else {
//       log('WARNING: Could not find passenger ID in tripDetails');
//     }
//   } catch (e) {
//     log('Error finding passenger ID: $e');
//   }
...
//   log('Using tripId for socket events: $tripId');
//   log('Socket initialization starting...');
//   socket = IO.io(Constants.apiBaseUrl, <String, dynamic>{
//     'transports': ['websocket'],
//     'autoConnect': true,
...
//       log('Received notification for passenger: $notification');
//       // Rest of your code...
//     });
//   } else {
//     log('WARNING: No passenger ID found for socket events');
//   }
...
//   log('Socket initialization complete');
// }
...
//       log('ShowRiderDetails - build method called');
//   log('tripDetails structure: ${widget.tripDetails.keys}');
//   log('initialTripDetails structure: ${widget.initialTripDetails.keys}');
...
//   minChildSize: 0.3, // Increase from 0 to 0.3 to ensure visibility
//   maxChildSize: 0.95,
...
//         color: Colors.white, // Change from black to white
//         borderRadius: const BorderRadius.only(
//           topLeft: Radius.circular(20),
//           topRight: Radius.circular(20),
//         ),
//         boxShadow: [  // Add shadow for visibility
//           BoxShadow(
...
class _ShowRiderDetailsState extends State<ShowRiderDetails> {
  ...
  final passengerId = widget.tripDetails['tripDetails']?['passenger']?['_id'] ?? 
