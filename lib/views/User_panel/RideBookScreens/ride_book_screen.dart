...
class RideBookScreen extends StatefulWidget {
  ...
  @override
  State<RideBookScreen> createState() => RideBookScreenState();
}

class RideBookScreenState extends State<RideBookScreen>
...
Future<void> _checkSharedPreferencesData() async {
  ...
  Future<void> _createTripRequest(BuildContext context) async {
    ...
    try {
      ...
      if (result['result'] != null && result['result']['_id'] != null) {
        ...
        log("Saved trip ID to SharedPreference================>>>s: $tripId");
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              labelStyle: AppTextTheme.getDarkTextTheme(context)
                                  .bodySmall,
    ...
    return Column(
      children: [
        TextField(
          ...
          decoration: InputDecoration(
            labelText: label,
            labelStyle: AppTextTheme.getDarkTextTheme(context).bodySmall,
  ...
  void _updateMapView() {
    ...
    _controller.future.catchError((error) {
      ...
      // Handle successful controller creation
      // Your existing camera updates
      final rideProvider = Provider.of<RideProvider>(context, listen: false);
