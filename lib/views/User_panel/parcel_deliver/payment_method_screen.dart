...
//                                         'cash') {
//                                       // Cash payment ka logic ya API hit karni hai
//                                       log('Cash payment selected. Handle accordingly.');
//                                       Navigator.pushReplacementNamed(
//                                           context, AppRoutes.ratingScreen);
//                                     } else if (selectedPaymentMethod ==
//                                         'card') {
//                                       // Future mein card payment ko handle karne ka function
//                                       // handleCardPayment();
//                                     }
//                                   },
//                                 ),
                                ...
                                if (isParcelDelivery &&
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      const SizedBox(height: 20),
                                      const Divider(
                                          color: AppColors.buttonColor, height: 1),
                                      const SizedBox(height: 20),
                                    ],
                                  ),
                                Container(
