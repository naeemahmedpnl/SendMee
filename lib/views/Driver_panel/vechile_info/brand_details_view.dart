...
//     setState(() {
//       _brandController.text = provider.formData.motorcycleModel ?? '';
//       _modelController.text = provider.formData.motorcycleYear ?? '';
...
//         year: _brandController.text.trim(),
...
//                   children: [
//                     Text(
//                       'brandDetails.brand'.tr(),
//                       style: AppTextTheme.getLightTextTheme(context).bodyLarge,
//                     ),
//                     SizedBox(height: screenHeight * 0.0075),
//                     CustomTextFormField(
//                       icon: Icons.directions_car,
//                       hintText: 'brandDetails.inputs.brandHint'.tr(),
//                       validator: (value) {
//                         if (value == null || value.trim().isEmpty) {
//                           return 'brandDetails.validation.brandRequired'.tr();
//                         }
//                         return null;
//                       },
...
//                     Text(
//                       'brandDetails.model'.tr(),
//                       style: AppTextTheme.getLightTextTheme(context).bodyLarge,
//                     ),
//                     SizedBox(height: screenHeight * 0.0075),
//                     CustomTextFormField(
//                       icon: Icons.model_training,
//                       hintText: 'brandDetails.inputs.modelHint'.tr(),
//                       validator: (value) {
//                         if (value == null || value.trim().isEmpty) {
//                           return 'brandDetails.validation.modelRequired'.tr();
//                         }
//                         return null;
//                       },
