...
import 'package:sendme/views/Driver_panel/widgets/option_tile.dart';
  ...
  Future<void> _submitRegistration() async {
    ...
    try {
      ...
      if (!_validateFormData(formData)) {
        _showMessage(
            'driverSignupParcel.errors.incompleteRegistration'.tr(), false);
        return;
      }
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                OptionTile(
                                  title:
                                      'driverSignupParcel.driverLicense'.tr(),
                                  onTap: () => Navigator.of(context)
                                      .pushNamed(AppDriverRoutes.driverLicense),
                                ),
                                OptionTile(
                                  title:
                                      'driverSignupParcel.proofOfAddress'.tr(),
                                  onTap: () => Navigator.of(context)
                                      .pushNamed(AppDriverRoutes.idInfo),
                                ),
                                OptionTile(
                                  title:
                                      'driverSignupParcel.idConfirmation'.tr(),
                                  onTap: () => Navigator.of(context)
